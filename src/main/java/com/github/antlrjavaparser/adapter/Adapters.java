...
public class Adapters {
	...
	private static LambdaParametersContextAdapter lambdaParametersContextAdapter = new LambdaParametersContextAdapter();
	private static LambdaBodyContextAdapter lambdaBodyExpressionContextAdapter = new LambdaBodyContextAdapter();
	...
	public static LambdaParametersContextAdapter getLambdaParameterExpressionContextAdapter() {
		return lambdaParametersContextAdapter;
	}

	public static LambdaBodyContextAdapter getLambdaBodyContextAdapter() {
		return lambdaBodyExpressionContextAdapter;
	}
}

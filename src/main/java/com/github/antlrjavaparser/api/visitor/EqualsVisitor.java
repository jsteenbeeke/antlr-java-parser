...
public class EqualsVisitor implements GenericVisitor<Boolean, Node> {
	...
	public Boolean visit(LambdaExpr n1, Node arg) {
		...
		/*
		 * if (!nodeEquals(n1.getScope(), n2.getScope())) { return
		 * Boolean.FALSE; }
		 * 
		 * if (!objEquals(n1.getName(), n2.getName())) { return Boolean.FALSE; }
		 * 
		 * if (!nodesEquals(n1.getArgs(), n2.getArgs())) { return Boolean.FALSE;
		 * }
		 * 
		 * if (!nodesEquals(n1.getTypeArgs(), n2.getTypeArgs())) { return
		 * Boolean.FALSE; }
		 */

		if (!nodeEquals(n1.getParameters(), n2.getParameters())) {
			return Boolean.FALSE;
		}
	...
	@Override
	public Boolean visit(SimpleLambdaParameterExpr n1, Node arg) {
		SimpleLambdaParameterExpr n2 = (SimpleLambdaParameterExpr) arg;

		if (!objEquals(n1.getIdentifiers(), n2.getIdentifiers())) {
			return Boolean.FALSE;
		}
	...
	@Override
	public Boolean visit(FormalLambdaParameterExpr n1, Node arg) {
		FormalLambdaParameterExpr n2 = (FormalLambdaParameterExpr) arg;
